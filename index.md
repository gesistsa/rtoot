...
from R. Get started by reading
[`vignette("rtoot")`](https://gesistsa.github.io/rtoot/articles/rtoot.md).
...
[`vignette("auth")`](https://gesistsa.github.io/rtoot/articles/auth.md))
...
any public status on any instance use
...
streams all statuses containing a specific hashtag
...
can be used to read in and convert a json to a data frame.
