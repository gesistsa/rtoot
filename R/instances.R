...
#' @rdname get_instance
#' @export
get_instance_peers <- function(
  instance = NULL,
  token = NULL,
  anonymous = TRUE
) {
  request_results <- make_get_request(
    token = token,
...
#' @rdname get_instance
#' @export
get_instance_activity <- function(
  instance = NULL,
  token = NULL,
  anonymous = TRUE
) {
...
#' @rdname get_instance
#' @export
get_instance_directory <- function(
  instance = NULL,
  token = NULL,
  offset = 0,
  limit = 40,
...
#' @rdname get_instance
#' @export
get_instance_rules <- function(
  instance = NULL,
  token = NULL,
  anonymous = FALSE
) {
  params <- list(instance = instance)
  request_results <- get_instance_general(
    instance = instance,
    token = token,
    anonymous = anonymous
  )$rules
